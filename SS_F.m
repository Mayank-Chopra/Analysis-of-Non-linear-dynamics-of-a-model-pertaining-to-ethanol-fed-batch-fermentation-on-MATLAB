...
%finding steady state values for different values of F
...
figure(1) %Steady state values for different values of F
F_vec = linspace(0.1,1,90);
subplot(221),plot(F_vec,xroot_vec(:,1))
ylabel('xss')
xlabel('F')

subplot(222),plot(F_vec,xroot_vec(:,2))
ylabel('Sss')
xlabel('F')

subplot(223),plot(F_vec,xroot_vec(:,3))
ylabel('p1ss')
xlabel('F')

subplot(224),plot(F_vec,xroot_vec(:,4))
ylabel('p2ss')
xlabel('F')
