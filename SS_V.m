...
%finding steady state values for different values of V
...
figure(1) %Steady state values for different values of V
V_vec = linspace(5,95,90);
subplot(221),plot(V_vec,xroot_vec(:,1))
ylabel('xss')
xlabel('Volume')

subplot(222),plot(V_vec,xroot_vec(:,2))
ylabel('Sss')
xlabel('Volume')

subplot(223),plot(V_vec,xroot_vec(:,3))
ylabel('p1ss')
xlabel('Volume')

subplot(224),plot(V_vec,xroot_vec(:,4))
ylabel('p2ss')
xlabel('Volume')
