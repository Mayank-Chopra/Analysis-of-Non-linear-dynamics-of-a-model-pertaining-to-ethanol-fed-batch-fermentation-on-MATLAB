...
%finding steady state values for different values of inital guess
...
figure(1) %Steady state values for different values of inital guess
in_g_vec = linspace(10,4910,49);
subplot(221),plot(in_g_vec,xroot_vec(:,1))
ylabel('xss')
xlabel('xin')

subplot(222),plot(in_g_vec,xroot_vec(:,2))
ylabel('Sss')
xlabel('Sin')

subplot(223),plot(in_g_vec,xroot_vec(:,3))
ylabel('p1ss')
xlabel('p1in')

subplot(224),plot(in_g_vec,xroot_vec(:,4))
ylabel('p2ss')
xlabel('p2in')
