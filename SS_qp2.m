...
%finding steady state values for different values of qp2
...
figure(1) %Steady state values for different values of qp2
qp2_vec = linspace(4,94,90);
subplot(221),plot(qp2_vec,xroot_vec(:,1))
ylabel('xss')
xlabel('qp2')

subplot(222),plot(qp2_vec,xroot_vec(:,2))
ylabel('Sss')
xlabel('qp2')

subplot(223),plot(qp2_vec,xroot_vec(:,3))
ylabel('p1ss')
xlabel('qp2')

subplot(224),plot(qp2_vec,xroot_vec(:,4))
ylabel('p2ss')
xlabel('qp2')
