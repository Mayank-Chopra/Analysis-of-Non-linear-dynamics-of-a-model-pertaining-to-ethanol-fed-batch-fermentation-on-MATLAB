...
%finding steady state values for different values of qp1
...
figure(1)%Steady state values for different values of qp1
qp1_vec = linspace(4,94,90);
subplot(221),plot(qp1_vec,xroot_vec(:,1))
ylabel('xss')
xlabel('qp1')

subplot(222),plot(qp1_vec,xroot_vec(:,2))
ylabel('Sss')
xlabel('qp1')

subplot(223),plot(qp1_vec,xroot_vec(:,3))
ylabel('p1ss')
xlabel('qp1')

subplot(224),plot(qp1_vec,xroot_vec(:,4))
ylabel('p2ss')
xlabel('qp1')
